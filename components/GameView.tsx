          ...
          <div className="flex flex-col h-full animate-in fade-in duration-1000">
            ...
            <div className="px-12 py-8 border-b border-white/10 bg-black/95 flex justify-between items-center backdrop-blur-3xl z-10 shadow-[0_10px_40px_rgba(0,0,0,0.8)]">
              <div className="flex items-center gap-12">
                <div className="space-y-2">
                  <span className="text-[9px] text-[#00f3ff]/40 uppercase font-black block tracking-[0.2em]">Operational_Sector</span>
                ...
                <div className="space-y-2">
                  <span className="text-[9px] text-[#ff00ff]/40 uppercase font-black block tracking-[0.2em]">Link_Status</span>
            ...
            <div className="flex-1 flex overflow-hidden">
              <div className="flex-1 relative bg-[#010101] overflow-hidden">
                ...
                <div className="absolute inset-0 z-30 pointer-events-none p-20 flex flex-col items-center gap-12">
                  {activeAds.map(ad => (
                    <div key={ad.id} className="pointer-events-auto shadow-[0_0_60px_rgba(0,0,0,1)] animate-in fade-in slide-in-from-top-12 duration-700">
                       ...
                       <div className="relative hover:scale-150 transition-transform duration-500">
                          ...
                          <div className="bg-black border-2 border-[#ff00ff] p-6 flex flex-col items-center gap-3 shadow-[0_0_50px_rgba(255,0,255,0.5)] group-hover:border-white transition-all">
                            ...
                            <div className="text-center space-y-1">
                               <span className="text-[10px] font-black text-white bg-[#ff00ff] px-3 py-1 tracking-tighter block">EXTRACT_DATA</span>
                ...
                {phase === 'COMPLETED' && (
                  <div className="absolute inset-0 z-[100] flex items-center justify-center bg-black/98 backdrop-blur-2xl animate-in fade-in zoom-in duration-700">
                    <div className="text-center p-24 border-2 border-[#00f3ff] bg-black/60 shadow-[0_0_150px_rgba(0,243,255,0.4)] max-w-3xl">
                      <Trophy size={140} className="text-[#00f3ff] mx-auto mb-12 animate-bounce neon-glow-cyan" />
                      <h2 className="text-8xl font-black text-white italic uppercase tracking-tighter mb-8 neon-glow-cyan">DATOVÁ_ŽEŇ_ÚSPĚŠNÁ</h2>
                      <p className="text-sm text-[#00f3ff] uppercase font-black mb-16 tracking-[0.5em] opacity-80 animate-pulse">Extraction Verified | Network Stabilized</p>
                      <button onClick={() => setActiveExpedition(false)} className="group relative px-32 py-10 bg-[#00f3ff] text-black font-black uppercase tracking-[0.8em] hover:bg-white transition-all text-lg overflow-hidden">
                        <span className="relative z-10">PŘIJMOUT_ODMĚNU</span>
              ...
              <div className="w-80 border-l border-white/5 bg-[#020202] flex flex-col shadow-[-30px_0_60px_rgba(0,0,0,0.8)] z-10">
                <div className="p-8 border-b border-white/10 flex items-center justify-between bg-black/60">
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-[11px] text-[#00f3ff] font-black uppercase tracking-[0.4em]">CONSOLE_VIEW</span>
                  </div>
                </div>
                <div className="flex-1 overflow-y-auto p-8 space-y-6 custom-scrollbar">
                  {logs.map(log => (
                    <div key={log.id} className={`text-[11px] uppercase leading-relaxed border-l-3 pl-5 transition-all animate-in slide-in-from-right-6 duration-500 ${log.type === 'success' ? 'border-green-500 text-green-400' : log.type === 'error' ? 'border-red-600 text-red-500' : 'border-[#00f3ff]/40 text-[#00f3ff]/60'}`}>
                      ...
                      <span className="font-black tracking-tight block leading-snug">{log.text}</span>
                    </div>
                  ))}
                </div>
                <div className="p-10 bg-black/95 border-t border-white/10 space-y-8">
                   <div className="space-y-4">
                      ...
                      <div className="h-3 bg-white/5 relative rounded-full overflow-hidden p-1 border border-white/10">
                        <div className="h-full bg-gradient-to-r from-[#00f3ff] to-[#ff00ff] shadow-[0_0_25px_rgba(0,243,255,0.8)] transition-all duration-300 rounded-full" style={{ width: `${progress}%` }} />
                      </div>
                   </div>
                </div>
              </div>
          ...
          <div className="max-w-7xl mx-auto py-24 px-16 w-full h-full overflow-y-auto custom-scrollbar bg-[radial-gradient(circle_at_center,rgba(0,243,255,0.03)_0%,transparent_100%)]">
            {activeTab === 'profile' && (
              <div className="space-y-20 animate-in slide-in-from-bottom-12 duration-1000">
                <div className="flex flex-col lg:flex-row items-center gap-20 p-20 bg-white/[0.02] border-2 border-white/10 relative overflow-hidden group shadow-2xl rounded-lg">
                  <div className="relative w-64 h-64 border-4 border-[#00f3ff] p-4 bg-black shadow-[0_0_80px_rgba(0,243,255,0.3)] overflow-hidden">
                  ...
                  <div className="space-y-10 relative z-10 flex-1">
                    <div className="space-y-3 text-center lg:text-left">
                       <span className="text-[12px] text-[#00f3ff] font-black uppercase tracking-[0.6em] opacity-40 block animate-pulse">Master_Admin_ID</span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
                      <div className="flex flex-col border-l-6 border-[#00f3ff] pl-10 py-3 bg-white/[0.03] backdrop-blur-md"><span className="text-[11px] text-[#00f3ff] font-black uppercase tracking-[0.4em] mb-3 opacity-60">MIKELA_RESERVES</span><span className="text-5xl font-black text-white tracking-tighter tabular-nums">{mikelaReserves.toLocaleString()} MK</span></div>
                      <div className="flex flex-col border-l-6 border-[#ff00ff] pl-10 py-3 bg-white/[0.03] backdrop-blur-md"><span className="text-[11px] text-[#ff00ff] font-black uppercase tracking-[0.4em] mb-3 opacity-60">REPUTATION_RANK</span><span className="text-5xl font-black text-white tracking-tighter tabular-nums">{reputation.toLocaleString()} XP</span></div>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                   {[
                     ...
                     { label: 'Anomalies Purged', val: adsDestroyed, color: '#ff00ff' },
                     { label: 'Network Uptime', val: '99.99%', color: '#10b981' }
                   ].map((stat, i) => (
              ...
              <div className="h-full flex flex-col items-center justify-center space-y-24 animate-in zoom-in duration-1000">
                <div className="w-full max-w-4xl text-center space-y-24 relative">
                  ...
                  <div className="space-y-10">
                    <h2 className="text-7xl font-black text-white uppercase italic tracking-[0.4em] leading-tight neon-glow-cyan">INICIACE_EXPEDICE</h2>
                    <p className="text-base text-[#00f3ff]/50 max-w-2xl mx-auto leading-loose tracking-[0.3em] uppercase font-black">
                      Detekována hluboká vrstva Sektoru 0x{expeditionLevel.toString(16).toUpperCase()}. <br/> 
                      Před vstupem je nutná autorizace HilltopAds linku.
                    </p>
                  </div>
                  <button 
                  ...
                  >
                    <div className="relative z-10 flex items-center gap-8">
                       ...
                       <span className="text-4xl font-black uppercase tracking-[0.6em]">AUTORIZOVAT</span>
                    </div>
                  </button>
                </div>
              </div>
                  ...
                  {upgrades.map(u => {
                    ...
                    return (
                      <div key={u.id} className={`p-16 border-2 transition-all duration-700 flex flex-col bg-white/[0.01] group relative rounded-sm ${canAfford ? 'border-white/10 hover:border-[#ff00ff]/60 hover:bg-white/[0.04]' : 'border-white/5 opacity-40 grayscale'}`}>
                        ...
                        >
                          {canAfford ? (
                            <>VYLEPŠIT | {cost.toLocaleString()} MK</>
                          ) : (
                            <><Lock size={24} /> LOCKED</>
                          )}
                        </button>
